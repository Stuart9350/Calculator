...
public class MainActivity extends AppCompatActivity {
    ...
    Button One,Two,Three,Four,Five,Six,Seven,Eight,Nine,Zero,Zero2,Decimal,Equal,Add,Subs,Mul,Div,Clear,Delete,Percent,backspace;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backspace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String word = DisplayL.getText().toString();
                int len = word.length();
                if(len>0){
                    DisplayL.setText(word.substring(0, len-1));
                }
            }
        });
    }
